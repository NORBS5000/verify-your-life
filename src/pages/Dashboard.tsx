        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 sm:mb-12 lg:mb-20 px-4">
            {user ? (
              ...
              <div className="flex justify-center max-w-md mx-auto">
                <Button
                  size="lg"
                  className="text-base sm:text-lg lg:text-xl px-6 sm:px-8 lg:px-12 py-6 sm:py-8 h-auto flex items-center justify-center w-full"
                  onClick={() => setShowSectorModal(true)}
                >
                  Apply for Loan
                  <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 ml-2" />
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              <Card className="p-4 sm:p-6 text-center hover:shadow-elegant-lg transition-all duration-300">
                <div className="w-8 h-8 sm:w-12 sm:h-12 bg-gradient-to-r from-primary to-accent rounded-lg flex items-center justify-center mx-auto mb-2 sm:mb-4">
                  <CheckCircle2 className="w-4 h-4 sm:w-6 sm:h-6 text-primary-foreground" />
                </div>
                <div className="text-lg sm:text-2xl font-bold text-primary mb-1 sm:mb-2">15K+</div>
                <div className="text-muted-foreground text-sm sm:text-base leading-tight">Applications Processed</div>
              </Card>
              <Card className="p-4 sm:p-6 text-center hover:shadow-elegant-lg transition-all duration-300">
                <div className="w-8 h-8 sm:w-12 sm:h-12 bg-gradient-to-r from-health-green to-health-yellow rounded-lg flex items-center justify-center mx-auto mb-2 sm:mb-4">
                  <DollarSign className="w-4 h-4 sm:w-6 sm:h-6 text-primary-foreground" />
                </div>
                <div className="text-lg sm:text-2xl font-bold text-health-green mb-1 sm:mb-2">$75M+</div>
                <div className="text-muted-foreground text-sm sm:text-base leading-tight">Loans Disbursed</div>
              </Card>
              <Card className="p-4 sm:p-6 text-center hover:shadow-elegant-lg transition-all duration-300 sm:col-span-2 lg:col-span-1">
                <div className="w-8 h-8 sm:w-12 sm:h-12 bg-gradient-to-r from-health-orange to-health-red rounded-lg flex items-center justify-center mx-auto mb-2 sm:mb-4">
                  <Clock className="w-4 h-4 sm:w-6 sm:h-6 text-primary-foreground" />
                </div>
                <div className="text-lg sm:text-2xl font-bold text-health-orange mb-1 sm:mb-2">2 min</div>
      ...
      <footer className="bg-card border-t border-border py-8 sm:py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="col-span-1 sm:col-span-2 lg:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-foreground">HealthNow PayLater</h3>
            ...
            <div>
              ...
              <div className="space-y-2 text-muted-foreground text-sm sm:text-base">
                <p>support@healthnowpaylater.com</p>
                <p>+1 (800) 123-4567</p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-border pt-6 sm:pt-8 text-center">
            <p className="text-muted-foreground text-sm sm:text-base">
              &copy; {new Date().getFullYear()} HealthNow PayLater. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
          ...
          <Card className="max-w-md w-full p-4 sm:p-6 lg:p-8 animate-scale-in max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6 lg:mb-8">
              <button
                ...
                className="w-full p-3 sm:p-4 lg:p-6 text-left border-2 border-primary/20 rounded-xl hover:border-primary hover:bg-primary/5 transition-all duration-300 group min-h-[70px] sm:min-h-[80px] lg:min-h-[100px]"
              >
              ...
              <button
                ...
                className="w-full p-3 sm:p-4 lg:p-6 text-left border-2 border-health-green/20 rounded-xl hover:border-health-green hover:bg-health-green/5 transition-all duration-300 group min-h-[70px] sm:min-h-[80px] lg:min-h-[100px]"
              >
                <div className="flex items-start gap-3 sm:gap-4">
